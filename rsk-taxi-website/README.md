...
Edit `data/site.ts` for Call Contact `7318387987`, for Whatsapp Contact `8830576443`, Connect with Email `rsktravellers01@gmail.com`. Edit `data/vehicles.ts` and `data/packages.ts` for all price placeholders. 
