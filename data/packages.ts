...
export const packages: TourPackage[] = [
  { slug: "north-goa", name: "North Goa day tour", eyebrow: "The coast, old forts & sunset water", summary: "A full day of North Goa's essential views, from Aguada's ramparts to a slow boat cruise.", bestTime: "October to May is ideal for clear sea views and comfortable beach stops.", prices: ["₹2700", "₹2700", "₹3500", "₹4000"], stops: [
  ...
  { slug: "south-goa", name: "South Goa day tour", eyebrow: "Heritage, temples & wide beaches", summary: "A considered route through Goa's cultural landmarks, finishing beside the long sands of Colva.", bestTime: "November to March brings gentle weather for heritage walks and beach time.", prices: ["₹2700", "₹2700", "₹3500", "₹4000"], stops: [
